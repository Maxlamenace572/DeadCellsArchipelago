...
ITEM_TABLE: Dict[str, tuple] = {
    ...
    # ── Skins / Fillers ───────────────────────────────────────────────
    "PrisonerGold":         (0x1200, FILR, DLC_BASE),
    "PrisonerSonGoku":      (0x1201, FILR, DLC_BASE),
    "PrisonerBlack":        (0x1202, FILR, DLC_BASE),
    "PrisonerGhost":        (0x1203, FILR, DLC_BASE),
    "PrisonerSewers":       (0x1204, FILR, DLC_BASE),
    "PrisonerSanta":        (0x1205, FILR, DLC_RISE_OF_GIANT),
    "PrisonerStilt":        (0x1206, FILR, DLC_BASE),
    "PrisonerSkeleton":     (0x1207, FILR, DLC_BASE),
    "PrisonerCarduus":      (0x1208, FILR, DLC_BASE),
    "PrisonerAphrodite":    (0x1209, FILR, DLC_BASE),
    "PrisonerShaman":       (0x120A, FILR, DLC_BASE),
    "PrisonerCloud":        (0x120B, FILR, DLC_BASE),
    "PrisonerHyperlight":   (0x120C, FILR, DLC_BASE),
    "PrisonerAladdin":      (0x120D, FILR, DLC_BASE),
    "PrisonerBison":        (0x120E, FILR, DLC_BASE),
    "PrisonerWarrior":      (0x120F, FILR, DLC_BASE),
    "PrisonerMage":         (0x1210, FILR, DLC_BASE),
    "PrisonerNeon":         (0x1211, FILR, DLC_BASE),
    "PrisonerBobby":        (0x1212, FILR, DLC_BASE),
    "PrisonerDemon":        (0x1213, FILR, DLC_BASE),
    "PrisonerSylvanian":    (0x1214, FILR, DLC_BASE),
    "PrisonerSand":         (0x1215, FILR, DLC_BASE),
    "PrisonerGOG":          (0x1216, FILR, DLC_BASE),
    "PrisonerFrench":       (0x1217, FILR, DLC_BASE),
    "PrisonerXmas":         (0x1218, FILR, DLC_BASE),
    "PrisonerGardener":     (0x1219, FILR, DLC_BAD_SEED),
    "PrisonerFriendlyHardy":(0x121A, FILR, DLC_BAD_SEED),
    "PrisonerMushroom":     (0x121B, FILR, DLC_BAD_SEED),
    "PrisonerFugitive":     (0x121C, FILR, DLC_BAD_SEED),
    "PrisonerBlowgunner":   (0x121D, FILR, DLC_BAD_SEED),
    "PrisonerTick":         (0x121E, FILR, DLC_BAD_SEED),
    "RoyalGardener":        (0x121F, FILR, DLC_BAD_SEED),
    "PrisonerRetro":        (0x1220, FILR, DLC_BASE),
    "FreemanSkin":          (0x1221, FILR, DLC_BASE),
    "PrisonerJavelinSnake": (0x1222, FILR, DLC_FATAL_FALLS),
    "PrisonerNecromant":    (0x1223, FILR, DLC_FATAL_FALLS),
    "PrisonerBootleg":      (0x1224, FILR, DLC_FATAL_FALLS),
    "PrisonerKamikaze":     (0x1225, FILR, DLC_BASE),
    "PrisonerCrossbowMan":  (0x1226, FILR, DLC_BASE),
    "PrisonerKillBill":     (0x1227, FILR, DLC_BASE),
    "KingDefault":          (0x1228, FILR, DLC_BASE),
    "KingWhite":            (0x1229, FILR, DLC_BASE),
    "BehemothDefault":      (0x122A, FILR, DLC_BASE),
    "Behemoth1":            (0x122B, FILR, DLC_BASE),
    "Behemoth2":            (0x122C, FILR, DLC_BASE),
    "Behemoth3":            (0x122D, FILR, DLC_BASE),
    "Behemoth4":            (0x122E, FILR, DLC_BASE),
    "BeholderDefault":      (0x122F, FILR, DLC_BASE),
    "Beholder1":            (0x1230, FILR, DLC_BASE),
    "Beholder2":            (0x1231, FILR, DLC_BASE),
    "Beholder3":            (0x1232, FILR, DLC_BASE),
    "Beholder4":            (0x1233, FILR, DLC_BASE),
    "AssassinDefault":      (0x1234, FILR, DLC_BASE),
    "Assassin1":            (0x1235, FILR, DLC_BASE),
    "Assassin2":            (0x1236, FILR, DLC_BASE),
    "Assassin3":            (0x1237, FILR, DLC_BASE),
    "Assassin4":            (0x1238, FILR, DLC_BASE),
    "GiantDefault":         (0x1239, FILR, DLC_RISE_OF_GIANT),
    "Giant1":               (0x123A, FILR, DLC_RISE_OF_GIANT),
    "Giant2":               (0x123B, FILR, DLC_RISE_OF_GIANT),
    "Giant3":               (0x123C, FILR, DLC_RISE_OF_GIANT),
    "Giant4":               (0x123D, FILR, DLC_RISE_OF_GIANT),
    "HotkDefault":          (0x123E, FILR, DLC_BASE),
    "Hotk1":                (0x123F, FILR, DLC_BASE),
    "Hotk2":                (0x1240, FILR, DLC_BASE),
    "Hotk3":                (0x1241, FILR, DLC_BASE),
    "Hotk4":                (0x1242, FILR, DLC_BASE),
    "Statue":               (0x1243, FILR, DLC_FATAL_FALLS),
    "CollectorDefault":     (0x1244, FILR, DLC_BASE),
    "TickDefault":          (0x1245, FILR, DLC_BAD_SEED),
    "Tick1":                (0x1246, FILR, DLC_BAD_SEED),
    "Tick2":                (0x1247, FILR, DLC_BAD_SEED),
    "Tick3":                (0x1248, FILR, DLC_BAD_SEED),
    "Tick4":                (0x1249, FILR, DLC_BAD_SEED),
    "TickSacrifice":        (0x124A, FILR, DLC_BAD_SEED),
    "GardenerDefault":      (0x124B, FILR, DLC_FATAL_FALLS),
    "Gardener1":            (0x124C, FILR, DLC_FATAL_FALLS),
    "Gardener2":            (0x124D, FILR, DLC_FATAL_FALLS),
    "Gardener3":            (0x124E, FILR, DLC_FATAL_FALLS),
    "Gardener4":            (0x124F, FILR, DLC_FATAL_FALLS),
    "Cultist":              (0x1250, PROG, DLC_FATAL_FALLS),
    "FlawlessBehemoth":     (0x1251, FILR, DLC_BASE),
    "FlawlessBeholder":     (0x1252, FILR, DLC_BASE),
    "FlawlessAssassin":     (0x1253, FILR, DLC_BASE),
    "FlawlessGiant":        (0x1254, FILR, DLC_RISE_OF_GIANT),
    "FlawlessHotk":         (0x1255, FILR, DLC_BASE),
    "FlawlessTick":         (0x1256, FILR, DLC_BAD_SEED),
    "FlawlessGardener":     (0x1257, FILR, DLC_FATAL_FALLS),
    "Snowman":              (0x1258, FILR, DLC_BASE),
    "SantaKLOS":            (0x1259, FILR, DLC_BASE),
    "HollowKnight":         (0x125A, FILR, DLC_BASE),
    "Blasphemous":          (0x125B, FILR, DLC_BASE),
    "Guacamelee":           (0x125C, FILR, DLC_BASE),
    "Skul":                 (0x125D, FILR, DLC_BASE),
    "HyperLightDrifter":    (0x125E, FILR, DLC_BASE),
    "CurseofTheDeadGods":   (0x125F, FILR, DLC_BASE),
    "SoulKnight":           (0x1260, FILR, DLC_BASE),
    "Staphy":               (0x1261, FILR, DLC_QUEEN_AND_SEA),
    "ANCHORGUY":            (0x1262, FILR, DLC_QUEEN_AND_SEA),
    "ServanteDefault":      (0x1263, FILR, DLC_QUEEN_AND_SEA),
    "Servante1":            (0x1264, FILR, DLC_QUEEN_AND_SEA),
    "Servante2":            (0x1265, FILR, DLC_QUEEN_AND_SEA),
    "Servante3":            (0x1266, FILR, DLC_QUEEN_AND_SEA),
    "Servante4":            (0x1267, FILR, DLC_QUEEN_AND_SEA),
    "FlawlessServante":     (0x1268, FILR, DLC_QUEEN_AND_SEA),
    "QueenDefault":         (0x1269, FILR, DLC_QUEEN_AND_SEA),
    "Queen1":               (0x126A, FILR, DLC_QUEEN_AND_SEA),
    "Queen2":               (0x126B, FILR, DLC_QUEEN_AND_SEA),
    "Queen3":               (0x126C, FILR, DLC_QUEEN_AND_SEA),
    "Queen4":               (0x126D, FILR, DLC_QUEEN_AND_SEA),
    "FlawlessQueen":        (0x126E, FILR, DLC_QUEEN_AND_SEA),
    "BlueErinaceus":        (0x126F, FILR, DLC_QUEEN_AND_SEA),
    "Banker":               (0x1270, FILR, DLC_BASE),
    "GuillainThief":        (0x1271, FILR, DLC_BASE),
    "Bobby":                (0x1272, FILR, DLC_BASE),
    "ShovelKnight":         (0x1273, FILR, DLC_BASE),
    "HotlineMiamiChicken":  (0x1274, FILR, DLC_BASE),
    "KatanaZero":           (0x1275, FILR, DLC_BASE),
    "RiskOfRain":           (0x1276, FILR, DLC_BASE),
    "Terraria":             (0x1277, FILR, DLC_BASE),
    "SlayTheSpire":         (0x1278, FILR, DLC_BASE),
    "Mentor":               (0x1279, FILR, DLC_BASE),
    "Mentor1":              (0x127A, FILR, DLC_BASE),
    "Mentor2":              (0x127B, FILR, DLC_BASE),
    "Mentor3":              (0x127C, FILR, DLC_BASE),
    "VictoriusBeheaded":    (0x127D, FILR, DLC_BASE),
    "VictoriusBeheaded1":   (0x127E, FILR, DLC_BASE),
    "VictoriusBeheaded2":   (0x127F, FILR, DLC_BASE),
    "VictoriusBeheaded3":   (0x1280, FILR, DLC_BASE),
    "Simon":                (0x1281, FILR, DLC_PURPLE),
    "Alucard":              (0x1282, FILR, DLC_PURPLE),
    "RichterROB":           (0x1283, FILR, DLC_PURPLE),
    "Sypha":                (0x1284, FILR, DLC_PURPLE),
    "Trevor":               (0x1285, FILR, DLC_PURPLE),
    "Maria":                (0x1286, FILR, DLC_PURPLE),
    "Hector":               (0x1287, FILR, DLC_PURPLE),
    "HauntedArmor":         (0x1288, FILR, DLC_PURPLE),
    "AdeleDefault":         (0x1289, FILR, DLC_PURPLE),
    "Adele1":               (0x128A, FILR, DLC_PURPLE),
    "Adele2":               (0x128B, FILR, DLC_PURPLE),
    "Adele3":               (0x128C, FILR, DLC_PURPLE),
    "Adele4":               (0x128D, FILR, DLC_PURPLE),
    "FlawlessAdele":        (0x128E, FILR, DLC_PURPLE),
    "DookuDefault":         (0x128F, FILR, DLC_PURPLE),
    "Dooku1":               (0x1290, FILR, DLC_PURPLE),
    "Dooku2":               (0x1291, FILR, DLC_PURPLE),
    "Dooku3":               (0x1292, FILR, DLC_PURPLE),
    "Dooku4":               (0x1293, FILR, DLC_PURPLE),
    "FlawlessDooku":        (0x1294, FILR, DLC_PURPLE),

    # ── Head cosmetics / Fillers ──────────────────────────────────────
    "BobbyFlame":           (0x1400, FILR, DLC_BASE),
    "ConciergeFlame":       (0x1401, FILR, DLC_BASE),
    "ConjunctiviusHead":    (0x1402, FILR, DLC_BASE),
    "MamaTickEye":          (0x1403, FILR, DLC_BASE),
    "TimeKeeperHat":        (0x1404, FILR, DLC_BASE),
    "GiantFlame":           (0x1405, FILR, DLC_BASE),
    "ScarecrowHat":         (0x1406, FILR, DLC_BASE),
    "HandOfTheKingFlame":   (0x1407, FILR, DLC_BASE),
    "ServantsMask":         (0x1408, FILR, DLC_BASE),
    "QueenFlame":           (0x1409, FILR, DLC_BASE),
    "CollectorHood":        (0x140A, FILR, DLC_BASE),
    "BlackHole":            (0x140B, FILR, DLC_BASE),
    "BlackHoleWhite":       (0x140C, FILR, DLC_BASE),
    "BlackHoleViolet":      (0x140D, FILR, DLC_BASE),
    "BlackHoleRed":         (0x140E, FILR, DLC_BASE),
    "BlackHoleGreen":       (0x140F, FILR, DLC_BASE),
    "BlackHoleBlue":        (0x1410, FILR, DLC_BASE),
    "Bitter":               (0x1411, FILR, DLC_BASE),
    "VortexHelloDarkness":  (0x1412, FILR, DLC_BASE),
    "VortexBadSeed":        (0x1413, FILR, DLC_BASE),
    "VortexAndSea":         (0x1414, FILR, DLC_BASE),
    "VortexFoundry":        (0x1415, FILR, DLC_BASE),
    "Guillain":             (0x1416, FILR, DLC_BASE),
    "Pecheur":              (0x1417, FILR, DLC_BASE),
    "StaphyHead":           (0x1418, FILR, DLC_BASE),
    "Flawless":             (0x1419, FILR, DLC_BASE),
    "CellHead":             (0x141A, FILR, DLC_BASE),
    "EvilEmpire":           (0x141B, FILR, DLC_BASE),
    "BlobbyFlame":          (0x141C, FILR, DLC_BASE),
    "GlitchyHead":          (0x141D, FILR, DLC_BASE),
    "MushroomBoi":          (0x141E, FILR, DLC_BASE),
    "HordesZeroHood":       (0x141F, FILR, DLC_BASE),
    "BlobbyFlameMagma":     (0x1420, FILR, DLC_BASE),
    "BlobbyFlameMalaise":   (0x1421, FILR, DLC_BASE),
    "BlobbyFlameGum":       (0x1422, FILR, DLC_BASE),
    "GlitchyHeadDeepSpace": (0x1423, FILR, DLC_BASE),
    "GlitchyHeadRed":       (0x1424, FILR, DLC_BASE),
    "BlowTorchBlack":       (0x1425, FILR, DLC_BASE),
    "BlowTorch":            (0x1426, FILR, DLC_BASE),
    "BlowTorchGold":        (0x1427, FILR, DLC_BASE),
    "BlowTorchRed":         (0x1428, FILR, DLC_BASE),
    "BossCellHead":         (0x1429, FILR, DLC_BASE),
