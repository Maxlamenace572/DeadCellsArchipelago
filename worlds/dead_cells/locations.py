...
LOCATION_TABLE: Dict[str, dict] = {
    ...
    "Ninja Outfit": {
        ...
        "dlc": "", "min_bc": 2, "item": "PrisonerBlack",  "rarity": "Rare",
        "sources": [{'biome': 'PrisonCourtyard', 'min_bc': 2, 'max_bc': 255, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Ninja'}, {'biome': 'Ossuary', 'min_bc': 3, 'max_bc': 255, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Ninja'}, {'biome': 'ClockTower', 'min_bc': 2, 'max_bc': 255, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Ninja'}, {'biome': 'Crypt', 'min_bc': 2, 'max_bc': 255, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Ninja'}, {'biome': 'Swamp', 'min_bc': 2, 'max_bc': 255, 'dlc': 'TheBadSeed', 'type': 'blueprint_enemy', 'mob': 'Ninja'}, {'biome': 'Bank', 'min_bc': 2, 'max_bc': 255, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Ninja'}, {'biome': 'PurpleGarden', 'min_bc': 2, 'max_bc': 255, 'dlc': 'Purple', 'type': 'blueprint_enemy', 'mob': 'Ninja'}],
    },
    "Frantic Sword": {
...
def get_valid_locations(enabled_dlcs, disabled_types, bc_level, created_locations):
    ...
    for loc_name, loc_data in LOCATION_TABLE.items():
        ...
        # Distillery (and Cavern Key) Locations without any Boss Cells in the pool 
